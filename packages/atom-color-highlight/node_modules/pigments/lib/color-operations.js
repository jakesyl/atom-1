(function() {
  var Color, MAX_PER_COMPONENT, clamp, clampInt, comma, cssColor, float, floatOrPercent, hexa, int, intOrPercent, notQuote, parseDegreesOrPercent, parseFloat, parseFloatOrPercent, parseInt, parseIntOrPercent, parseParam, pe, percent, ps, split, strip, variables, _ref, _ref1,
    __slice = [].slice;
  ...
  _ref1 = require('./utils'), strip = _ref1.strip, split = _ref1.split, clamp = _ref1.clamp, clampInt = _ref1.clampInt, parseInt = _ref1.parseInt, parseFloat = _ref1.parseFloat, parseIntOrPercent = _ref1.parseIntOrPercent, parseFloatOrPercent = _ref1.parseFloatOrPercent, parseDegreesOrPercent = _ref1.parseDegreesOrPercent;
  ...
  Color.addExpression('adjust-hue', "adjust-hue" + ps + "(" + notQuote + ")" + comma + "(-?" + int + "deg|" + variables + "|-?" + percent + ")" + pe, function(color, expression, fileVariables) {
    var amount, baseColor, h, l, s, subexpr, _, _ref2, _ref3;
    _ref2 = this.onigRegExp.searchSync(expression), _ = _ref2[0], subexpr = _ref2[1], amount = _ref2[2];
    subexpr = subexpr.match;
    amount = parseFloat(amount.match, fileVariables);
